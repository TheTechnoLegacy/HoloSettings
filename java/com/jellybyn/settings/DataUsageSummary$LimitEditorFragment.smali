.class public Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;
...
.method public static show(Lcom/jellybyn/settings/DataUsageSummary;)V
    ...
    .line 1837
    new-instance v1, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;

    invoke-direct {v1}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;-><init>()V

    .line 1838
    .local v1, "dialog":Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;
    invoke-virtual {v1, v0}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 1839
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 1845
    invoke-virtual {p0}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    .line 1846
    .local v7, "context":Landroid/content/Context;
    invoke-virtual {p0}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    new-instance v0, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment$1;-><init>(Lcom/jellybyn/settings/DataUsageSummary$LimitEditorFragment;Landroid/widget/NumberPicker;Lcom/jellybyn/settings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/jellybyn/settings/DataUsageSummary;)V
