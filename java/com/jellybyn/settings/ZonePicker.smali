.class public Lcom/jellybyn/settings/ZonePicker;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/jellybyn/settings/ZonePicker$MyComparator;,
        Lcom/jellybyn/settings/ZonePicker$ZoneSelectionListener;
    }
.end annotation
...
.field private mListener:Lcom/jellybyn/settings/ZonePicker$ZoneSelectionListener;
...
.method public static constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;
    ...
    invoke-static {p0, p1, v0}, Lcom/jellybyn/settings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;ZI)Landroid/widget/SimpleAdapter;
...
.method public static constructTimezoneAdapter(Landroid/content/Context;ZI)Landroid/widget/SimpleAdapter;
    ...
    :goto_0
    new-instance v6, Lcom/jellybyn/settings/ZonePicker$MyComparator;

    invoke-direct {v6, v7}, Lcom/jellybyn/settings/ZonePicker$MyComparator;-><init>(Ljava/lang/String;)V

    .line 101
    .local v6, "comparator":Lcom/jellybyn/settings/ZonePicker$MyComparator;
    invoke-static {p0}, Lcom/jellybyn/settings/ZonePicker;->getZones(Landroid/content/Context;)Ljava/util/List;
    ...
    .end local v6    # "comparator":Lcom/jellybyn/settings/ZonePicker$MyComparator;
...
.method private static getZones(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v5, v3, v2, v0, v1}, Lcom/jellybyn/settings/ZonePicker;->addItem(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;J)V
...
.method private setSorting(Z)V
    ...
    iget-object v0, p0, Lcom/jellybyn/settings/ZonePicker;->mTimezoneSortedAdapter:Landroid/widget/SimpleAdapter;

    .line 212
    .local v0, "adapter":Landroid/widget/SimpleAdapter;
    :goto_0
    invoke-virtual {p0, v0}, Lcom/jellybyn/settings/ZonePicker;->setListAdapter(Landroid/widget/ListAdapter;)V

    .line 213
    iput-boolean p1, p0, Lcom/jellybyn/settings/ZonePicker;->mSortedByTimezone:Z
    ...
    invoke-static {v0, v2}, Lcom/jellybyn/settings/ZonePicker;->getTimeZoneIndex(Landroid/widget/SimpleAdapter;Ljava/util/TimeZone;)I
    ...
    .line 216
    invoke-virtual {p0, v1}, Lcom/jellybyn/settings/ZonePicker;->setSelection(I)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/jellybyn/settings/ZonePicker;->mAlphabeticalAdapter:Landroid/widget/SimpleAdapter;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 150
    invoke-virtual {p0}, Lcom/jellybyn/settings/ZonePicker;->getActivity()Landroid/app/Activity;
    ...
    invoke-static {v0, v1}, Lcom/jellybyn/settings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;

    move-result-object v1

    iput-object v1, p0, Lcom/jellybyn/settings/ZonePicker;->mTimezoneSortedAdapter:Landroid/widget/SimpleAdapter;

    .line 152
    invoke-static {v0, v2}, Lcom/jellybyn/settings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;

    move-result-object v1

    iput-object v1, p0, Lcom/jellybyn/settings/ZonePicker;->mAlphabeticalAdapter:Landroid/widget/SimpleAdapter;

    .line 155
    invoke-direct {p0, v2}, Lcom/jellybyn/settings/ZonePicker;->setSorting(Z)V

    .line 156
    invoke-virtual {p0, v2}, Lcom/jellybyn/settings/ZonePicker;->setHasOptionsMenu(Z)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-static {p2, v1, v0, v2}, Lcom/jellybyn/settings/Utils;->forcePrepareCustomPreferencesList(Landroid/view/ViewGroup;Landroid/view/View;Landroid/widget/ListView;Z)V
...
.method public onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    iget-object v5, p0, Lcom/jellybyn/settings/ZonePicker;->mListener:Lcom/jellybyn/settings/ZonePicker$ZoneSelectionListener;
    ...
    invoke-interface {v5, v3}, Lcom/jellybyn/settings/ZonePicker$ZoneSelectionListener;->onZoneSelected(Ljava/util/TimeZone;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 193
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/jellybyn/settings/ZonePicker;->setSorting(Z)V

    goto :goto_0

    .line 197
    :pswitch_1
    invoke-direct {p0, v1}, Lcom/jellybyn/settings/ZonePicker;->setSorting(Z)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    .line 179
    iget-boolean v0, p0, Lcom/jellybyn/settings/ZonePicker;->mSortedByTimezone:Z
