.class public Lcom/jellybyn/settings/MasterClear;
...
.method public constructor <init>()V
    ...
    .line 123
    new-instance v0, Lcom/jellybyn/settings/MasterClear$1;

    invoke-direct {v0, p0}, Lcom/jellybyn/settings/MasterClear$1;-><init>(Lcom/jellybyn/settings/MasterClear;)V

    iput-object v0, p0, Lcom/jellybyn/settings/MasterClear;->mInitiateListener:Landroid/view/View$OnClickListener;

    return-void
.end method

.method static synthetic access$000(Lcom/jellybyn/settings/MasterClear;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/jellybyn/settings/MasterClear;
    .param p1, "x1"    # I

    .prologue
    .line 54
    invoke-direct {p0, p1}, Lcom/jellybyn/settings/MasterClear;->runKeyguardConfirmation(I)Z
...
.method static synthetic access$100(Lcom/jellybyn/settings/MasterClear;)V
    .locals 0
    .param p0, "x0"    # Lcom/jellybyn/settings/MasterClear;

    .prologue
    .line 54
    invoke-direct {p0}, Lcom/jellybyn/settings/MasterClear;->showFinalConfirmation()V

    return-void
.end method

.method static synthetic access$200(Lcom/jellybyn/settings/MasterClear;)Landroid/widget/CheckBox;
    .locals 1
    .param p0, "x0"    # Lcom/jellybyn/settings/MasterClear;

    .prologue
    .line 54
    iget-object v0, p0, Lcom/jellybyn/settings/MasterClear;->mExternalStorage:Landroid/widget/CheckBox;
...
.method private establishInitialState()V
    ...
    .line 145
    iget-object v3, p0, Lcom/jellybyn/settings/MasterClear;->mContentView:Landroid/view/View;
    ...
    iput-object v3, p0, Lcom/jellybyn/settings/MasterClear;->mInitiateButton:Landroid/widget/Button;

    .line 146
    iget-object v3, p0, Lcom/jellybyn/settings/MasterClear;->mInitiateButton:Landroid/widget/Button;

    iget-object v5, p0, Lcom/jellybyn/settings/MasterClear;->mInitiateListener:Landroid/view/View$OnClickListener;
    ...
    iput-object v3, p0, Lcom/jellybyn/settings/MasterClear;->mExternalStorageContainer:Landroid/view/View;
    ...
    iput-object v3, p0, Lcom/jellybyn/settings/MasterClear;->mExternalStorage:Landroid/widget/CheckBox;
    ...
    invoke-direct {p0}, Lcom/jellybyn/settings/MasterClear;->isExtStorageEncrypted()Z
    ...
    .line 160
    :cond_0
    iget-object v3, p0, Lcom/jellybyn/settings/MasterClear;->mExternalStorageContainer:Landroid/view/View;
    ...
    .line 170
    iget-object v5, p0, Lcom/jellybyn/settings/MasterClear;->mExternalStorage:Landroid/widget/CheckBox;
    ...
    :goto_1
    invoke-direct {p0}, Lcom/jellybyn/settings/MasterClear;->loadAccountList()V
    ...
    new-instance v4, Lcom/jellybyn/settings/MasterClear$2;

    invoke-direct {v4, p0}, Lcom/jellybyn/settings/MasterClear$2;-><init>(Lcom/jellybyn/settings/MasterClear;)V
...
.method private loadAccountList()V
    ...
    iget-object v0, v0, Lcom/jellybyn/settings/MasterClear;->mContentView:Landroid/view/View;

    move-object/from16 v21, v0

    const v22, 0x7f0800b5
    ...
    .line 194
    invoke-virtual/range {p0 .. p0}, Lcom/jellybyn/settings/MasterClear;->getActivity()Landroid/app/Activity;
...
.method private runKeyguardConfirmation(I)Z
    ...
    .prologue
    .line 73
    invoke-virtual {p0}, Lcom/jellybyn/settings/MasterClear;->getActivity()Landroid/app/Activity;
    ...
    invoke-virtual {v1, p1, v2, v3}, Lcom/jellybyn/settings/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method private showFinalConfirmation()V
    ...
    .line 112
    const-class v0, Lcom/jellybyn/settings/MasterClearConfirm;
    ...
    iget-object v3, p0, Lcom/jellybyn/settings/MasterClear;->mExternalStorage:Landroid/widget/CheckBox;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 106
    :cond_1
    invoke-direct {p0}, Lcom/jellybyn/settings/MasterClear;->establishInitialState()V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/jellybyn/settings/MasterClear;->mContentView:Landroid/view/View;

    .line 253
    invoke-direct {p0}, Lcom/jellybyn/settings/MasterClear;->establishInitialState()V

    .line 254
    iget-object v0, p0, Lcom/jellybyn/settings/MasterClear;->mContentView:Landroid/view/View;
