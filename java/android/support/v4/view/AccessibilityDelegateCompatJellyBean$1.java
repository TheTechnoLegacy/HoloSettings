...
class AccessibilityDelegateCompatJellyBean$1 extends AccessibilityDelegate {
    ...
    AccessibilityDelegateCompatJellyBean$1(AccessibilityDelegateBridgeJellyBean accessibilityDelegateBridgeJellyBean) {
    ...
    public AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
        return this.val$bridge.getAccessibilityNodeProvider(view);
    }
