.class public Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->ENGLISH_LOCALE:Ljava/util/Locale;
    ...
    sput-object v0, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sput-object v0, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSubtypeSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method public static buildInputMethodsAndSubtypesString(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
    ...
    invoke-static {p0, v1, v3}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->buildEnabledInputMethodsString(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/util/HashSet;)V
...
.method private static getDisabledSystemIMEs(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    ...
    .line 150
    :cond_1
    sget-object v2, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method private static getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    .line 126
    :cond_1
    sget-object v5, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sget-object v5, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSubtypeSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method public static isAlwaysCheckedIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;I)Z
    ...
    .line 384
    :cond_1
    invoke-static {p0}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->isSystemIme(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    .line 387
    :cond_2
    invoke-static {p0}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->isAuxiliaryIme(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    .line 390
    :cond_3
    invoke-static {p0, p1}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->isValidDefaultIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    .line 393
    sget-object v0, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->ENGLISH_LOCALE:Ljava/util/Locale;

    invoke-virtual {v0}, Ljava/util/Locale;->getLanguage()Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, v0}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->containsSubtypeOf(Landroid/view/inputmethod/InputMethodInfo;Ljava/lang/String;)Z
...
.method private static isInputMethodSubtypeSelected(Landroid/content/ContentResolver;)Z
    ...
    .prologue
    .line 105
    invoke-static {p0}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->getInputMethodSubtypeSelected(Landroid/content/ContentResolver;)I
...
.method private static isValidDefaultIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    invoke-static {p0, v2}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->containsSubtypeOf(Landroid/view/inputmethod/InputMethodInfo;Ljava/lang/String;)Z
    :try_end_0
...
.method public static loadInputMethodSubtypeList(Lcom/jellybyn/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Ljava/util/Map;)V
    .locals 10
    .param p0, "context"    # Lcom/jellybyn/settings/SettingsPreferenceFragment;
    .param p1, "resolver"    # Landroid/content/ContentResolver;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/jellybyn/settings/SettingsPreferenceFragment;",
            "Landroid/content/ContentResolver;",
            "Ljava/util/List",
            "<",
            "Landroid/view/inputmethod/InputMethodInfo;",
    ...
    invoke-static {p1}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v6}, Lcom/jellybyn/settings/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    :cond_1
    invoke-static {p0, p2, v6, v7}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->setSubtypesPreferenceEnabled(Lcom/jellybyn/settings/SettingsPreferenceFragment;Ljava/util/List;Ljava/lang/String;Z)V
    ...
    :cond_2
    invoke-static {p0, p2, v2}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->updateSubtypesPreferenceChecked(Lcom/jellybyn/settings/SettingsPreferenceFragment;Ljava/util/List;Ljava/util/HashMap;)V
...
.method public static saveInputMethodSubtypeList(Lcom/jellybyn/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V
    .locals 27
    .param p0, "context"    # Lcom/jellybyn/settings/SettingsPreferenceFragment;
    .param p1, "resolver"    # Landroid/content/ContentResolver;
    ...
    invoke-static/range {p1 .. p1}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->getInputMethodSubtypeSelected(Landroid/content/ContentResolver;)I

    move-result v17

    .line 185
    .local v17, "selectedInputMethodSubtype":I
    invoke-static/range {p1 .. p1}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    invoke-static/range {p1 .. p1}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->getDisabledSystemIMEs(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    ...
    invoke-virtual {v0, v12}, Lcom/jellybyn/settings/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-static {v10}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->isSystemIme(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/jellybyn/settings/SettingsPreferenceFragment;->getActivity()Landroid/app/Activity;

    move-result-object v25

    move-object/from16 v0, v25

    invoke-static {v10, v0, v11}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->isAlwaysCheckedIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;I)Z
    ...
    invoke-virtual {v0, v1}, Lcom/jellybyn/settings/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-static {v3, v7}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->buildInputMethodsAndSubtypesString(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
    ...
    invoke-static {v5, v6}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->buildDisabledSystemInputMethods(Ljava/lang/StringBuilder;Ljava/util/HashSet;)V

    .line 284
    if-nez v15, :cond_d

    invoke-static/range {p1 .. p1}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->isInputMethodSubtypeSelected(Landroid/content/ContentResolver;)Z
    ...
    invoke-static {v0, v1}, Lcom/jellybyn/settings/inputmethod/InputMethodAndSubtypeUtil;->putSelectedInputMethodSubtype(Landroid/content/ContentResolver;I)V
...
.method public static setSubtypesPreferenceEnabled(Lcom/jellybyn/settings/SettingsPreferenceFragment;Ljava/util/List;Ljava/lang/String;Z)V
    .locals 9
    .param p0, "context"    # Lcom/jellybyn/settings/SettingsPreferenceFragment;
    ...
    invoke-virtual {p0}, Lcom/jellybyn/settings/SettingsPreferenceFragment;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method public static updateSubtypesPreferenceChecked(Lcom/jellybyn/settings/SettingsPreferenceFragment;Ljava/util/List;Ljava/util/HashMap;)V
    .locals 11
    .param p0, "context"    # Lcom/jellybyn/settings/SettingsPreferenceFragment;
    .annotation system Ldalvik/annotation/Signature;
        value = {
