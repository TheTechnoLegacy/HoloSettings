...
class WifiStatusTest$5 extends Thread {
    final /* synthetic */ WifiStatusTest this$0;
    final /* synthetic */ Handler val$handler;
    final /* synthetic */ Runnable val$updatePingResults;

    public void run() {
        WifiStatusTest.access$2300(this.this$0);
        this.val$handler.post(this.val$updatePingResults);
    }

    WifiStatusTest$5(WifiStatusTest wifiStatusTest, Handler handler, Runnable runnable) {
