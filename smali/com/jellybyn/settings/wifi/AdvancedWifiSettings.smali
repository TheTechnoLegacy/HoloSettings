.class public Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;
...
.method private initPreferences()V
    ...
    invoke-virtual {p0, v10}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 80
    iget-object v10, p0, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 85
    invoke-virtual {p0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->getActivity()Landroid/app/Activity;

    move-result-object v10

    invoke-static {v10}, Lcom/jellybyn/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z
    ...
    .line 86
    invoke-virtual {p0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 119
    invoke-direct {p0, v0, v9}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    ...
    .line 141
    invoke-direct {p0, v6, v7}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
...
.method private refreshWifiInfo()V
    ...
    .line 229
    iget-object v5, p0, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {p0, v5}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-static {v5}, Lcom/jellybyn/settings/Utils;->getWifiIpAddresses(Landroid/content/Context;)Ljava/lang/String;
...
.method private updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    ...
    .prologue
    .line 166
    invoke-virtual {p0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->getResources()Landroid/content/res/Resources;
...
.method private updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/jellybyn/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/net/wifi/WifiManager;

    iput-object v0, p0, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->addPreferencesFromResource(I)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 204
    invoke-direct {p0, p1, v4}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    :try_end_0
    ...
    .line 217
    invoke-direct {p0, p1, v3}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
    :try_end_1
...
.method public onResume()V
    ...
    .line 71
    invoke-direct {p0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->initPreferences()V

    .line 72
    invoke-direct {p0}, Lcom/jellybyn/settings/wifi/AdvancedWifiSettings;->refreshWifiInfo()V
