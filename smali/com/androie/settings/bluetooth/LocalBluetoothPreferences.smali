.class final Lcom/androie/settings/bluetooth/LocalBluetoothPreferences;
...
.method static synthetic access$000(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    .prologue
    .line 28
    invoke-static {p0}, Lcom/androie/settings/bluetooth/LocalBluetoothPreferences;->getSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method static persistDiscoveringTimestamp(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/androie/settings/bluetooth/LocalBluetoothPreferences$1;

    invoke-direct {v1, p0}, Lcom/androie/settings/bluetooth/LocalBluetoothPreferences$1;-><init>(Landroid/content/Context;)V
...
.method static shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 63
    .local v8, "manager":Lcom/androie/settings/bluetooth/LocalBluetoothManager;
    if-nez v8, :cond_0
    ...
    .line 68
    :cond_0
    invoke-virtual {v8}, Lcom/androie/settings/bluetooth/LocalBluetoothManager;->isForegroundActivity()Z
    ...
    .line 90
    :cond_3
    invoke-virtual {v8}, Lcom/androie/settings/bluetooth/LocalBluetoothManager;->getBluetoothAdapter()Lcom/androie/settings/bluetooth/LocalBluetoothAdapter;

    move-result-object v0

    .line 91
    .local v0, "adapter":Lcom/androie/settings/bluetooth/LocalBluetoothAdapter;
    if-eqz v0, :cond_4
