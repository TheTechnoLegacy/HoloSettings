.class public Lcom/androie/settings/wifi/AdvancedWifiSettings;
...
.method private initPreferences()V
    ...
    invoke-virtual {p0, v12}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 82
    iget-object v12, p0, Lcom/androie/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 87
    invoke-virtual {p0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->getActivity()Landroid/app/Activity;

    move-result-object v12

    invoke-static {v12}, Lcom/androie/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z
    ...
    .line 88
    invoke-virtual {p0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 121
    invoke-direct {p0, v1, v10}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    ...
    .line 154
    invoke-direct {p0, v7, v8}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
...
.method private refreshWifiInfo()V
    ...
    .line 255
    iget-object v5, p0, Lcom/androie/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {p0, v5}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-static {v5}, Lcom/androie/settings/Utils;->getWifiIpAddresses(Landroid/content/Context;)Ljava/lang/String;
...
.method private updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    ...
    .prologue
    .line 182
    invoke-virtual {p0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->getResources()Landroid/content/res/Resources;
...
.method private updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/androie/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/net/wifi/WifiManager;

    iput-object v0, p0, Lcom/androie/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->addPreferencesFromResource(I)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 220
    invoke-direct {p0, p1, v4}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    :try_end_0
    ...
    .line 230
    :try_start_1
    iget-object v8, p0, Lcom/androie/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 243
    invoke-direct {p0, p1, v3}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
    :try_end_2
...
.method public onResume()V
    ...
    .line 73
    invoke-direct {p0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->initPreferences()V

    .line 74
    invoke-direct {p0}, Lcom/androie/settings/wifi/AdvancedWifiSettings;->refreshWifiInfo()V
