...
.method public static delete(Landroid/content/Context;Lcom/koushikdutta/superuser/db/UidPolicy;)V
    .locals 8
    ...
    const-string v2, "uid = ? and command = ? and desired_uid = ?"
    ...
    iget v4, p1, Lcom/koushikdutta/superuser/db/UidPolicy;->desiredUid:I
    ...
    const-string v2, "uid = ? and desired_uid = ?"
